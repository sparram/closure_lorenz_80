...
def run_level3_validation_xyz(n_ensemble=30, n_steps=10000, dt=4.2e-3, skip_transient=4000000):
    ...
    y_ensemble = y_init.repeat(n_ensemble, 1) + torch.randn(n_ensemble, 3, device=device) * 1e-20
    ...
    plt.tight_layout()
    plt.savefig("media/sim_closed_loop_or.png")
    plt.show()
