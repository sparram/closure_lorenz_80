...
def run_level2_scatter_validation(file_path='data/NN_training_data.mat', stats_path='checkpoints/norm_stats_hlf.pt', num_samples=100000, skip_transient=4000000):
    ...
    with torch.no_grad():
        hat_x_norm, hat_z_norm = cfm.sample(Y_norm, steps=20)
    ...
    plt.tight_layout()
    plt.savefig("media/xz_open_loop.png")
    plt.show()
